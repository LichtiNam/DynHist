...
public class CompressedHistogramImplTest {
  ...
  public void setUp() {
    ...
    int buckets = 6;
    histogram = new CompressedHistogramImpl(buckets, 1);
  }
  ...
  public void histogramTest() {
    ...
    assertEquals(1.23, hist.get(1).getLeftBorder(), 0.1);
    assertEquals(1.43, hist.get(2).getLeftBorder(), 0.1);
    assertEquals(1.61, hist.get(3).getLeftBorder(), 0.1);
    assertEquals(2.57, hist.get(4).getLeftBorder(), 0.1);
    assertEquals(2.8, hist.get(5).getLeftBorder(), 0.1);
